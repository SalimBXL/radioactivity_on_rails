...
class ProductionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create production" do
    assert_difference('Production.count') do
      post productions_url, params: { production: { calibration: @production.calibration, ref: @production.ref, tracer: @production.tracer } }
    end
  ...
  test "should update production" do
    patch production_url(@production), params: { production: { calibration: @production.calibration, ref: @production.ref, tracer: @production.tracer } }
